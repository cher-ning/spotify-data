---
title: "The Evolution of Linkin Park: Evaluating Loudness and Noise Across Time"
author: 
  - Cher Ning-Li
  - Kevin Roe
...
This dataset on Linkin Park on Spotify was scraped using the Spotify API [@citeSpotify]. The variables of interest in the paper are Album Release Date, which shows when the album was released. We're also interested in instrumentalness, which predicts if a track has no vocals, and loudness, which shows how loud a song is. We believe these two variables characterize key elements of rock music: instrumental solos and loud vocals.
